...
class DD_1     {
  String DropDownCode;
  String DropDownValue ='Drop_Down_1';
        ...
        child: FlatButton(
          onPressed: () {
            widget.parent.setState(() {
              ...
              if(  body.dropDown_timeSheet.dependentDropDown_1 .  DropDownValue.toString().compareTo(   element['${ProjectD1.prjtypcod}'].toString())!=0)
              reset(   body.dropDown_timeSheet.dependentDropDown_2, body.dropDown_timeSheet.dependentDropDown_3, body.dropDown_timeSheet.dependentDropDown_4);

              body.dropDown_timeSheet.dependentDropDown_1 .  DropDownValue =
                  element['${ProjectD1.prjtypcod}'].toString();

              body.dropDown_timeSheet.dependentDropDown_1 .  DropDownCode =
                  element['${ProjectD1.prjtypidd}'].toString();
